...
extern "C" DLL_API IVideoPlayer* CreateVideoPlayer();
extern "C"  DLL_API void ReleaseVideoPlayer(IVideoPlayer*);
extern "C"  DLL_API void ReleaseVideoFrame(IVideoFrame*);
