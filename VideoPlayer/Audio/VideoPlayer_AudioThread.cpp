    ...
    while (1) {
        ...
        if (got_frame) {
            ...
            if (aFrame_ReSample->nb_samples != aFrame->nb_samples) {
                ...
                av_samples_fill_arrays(aFrame_ReSample->data,
                                       aFrame_ReSample->linesize, audio_buf,
                                       audio_tgt_channels, aFrame_ReSample->nb_samples, out_sample_fmt, 0);
            }
            int len2 = swr_convert(swrCtx, aFrame_ReSample->data, aFrame_ReSample->nb_samples, 
